...
1) Drag the "lib" folder inside "Autozoom" into your moonloader folder. 
  Replace every file to make sure you possess my library correctly.
  
2) Place "autozoom.lua" inside your moonloader folder.

3) Use your external reloader or restart your game.

4) While ingame, use /az to toggle your autozoom.
